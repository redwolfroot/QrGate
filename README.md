...
- **Live Door Counter**: Every handheld shows “142 / 230 eingelassen” for today, the same on all devices within seconds, plus the list of active scanners with their names (“Tor 1”) and scan counts
